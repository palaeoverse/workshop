...
- RProjects are a way to organize your work in RStudio
  ...
  - Opening the project sets the working directory automatically after
...
All paths are set relative to the `.RProj` file
...
## Aside: Workspace Hygiene {.nostretch}
