...
│   └── workshop_intro.qmd -- slides
├── 02_workflow -- materials for the reproducible workflow module
│   ├── images
│   │   └── ... -- various images specific to this module
│   ├── index.qmd -- landing page
...
│   └── DataAcquisition_GSA2025.pdf -- slides
├── 04_exploration -- materials for the data exploration and cleaning module
│   ├── index.qmd -- landing page
│   └── cenozoic_crocs.csv -- data for module
├── 05_visualization -- materials for the data visualization module
│   ├── index.qmd -- landing page
│   ├── data_viz_gsa.qmd -- slides
│   ├── cenozoic_crocs_clean.csv -- data for module
│   ├── crocs_fossil_test.csv -- data for module
│   └── images
│   │   └── ... -- various images specific to this module
├── 06_ethical -- materials for the ethical open science module
│   ├── index.qmd -- landing page
│   └── GSAOpenScience.pdf -- slides
