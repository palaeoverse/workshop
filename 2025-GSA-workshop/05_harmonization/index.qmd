...
Let's see what you and those sitting around you can produce using the iris dataset built into R. Here's a basic plot of Sepal Length versus Petal Length:
...
Feel free to edit the r script directly above by changing the variables, coloring the points by species, fixing the axis labels, etc.
